...
export type Page = 'landing' | 'dashboard' | 'agent' | 'execute' | 'strategies' | 'proof' | 'timeline' | 'settings' | 'advanced' | 'docs' | 'hedera';
...
function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'hedera':
        return <HederaIntegration onNavigate={setCurrentPage} />;
      case 'landing':
      default:
